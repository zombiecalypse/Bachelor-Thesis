...
Variables have a more complex structure \TODO\lineofthought{image}:
...
\TODO\lineofthought{combined variables image} It is clear, that the only 
...
$i$ makes $j$ true if taken as $True$, then the $j$th such pair\TODO contains 
...
\begin{proof}
  ...
  %
	...
	state and for this, how a Turing machine works. % TODO is that English???
